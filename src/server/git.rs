...
pub(super) use diff::{
    collect_project_diff, collect_project_file_diff, file_baseline, project_is_dirty,
};
#[cfg(test)]
...
pub(super) use types::{FileSectionKind, GitDiffReport, GitFileChange, GitFileDiff};
